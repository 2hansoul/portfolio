...
<%
//디테일서블릿에서 set하고 get으로 가지고 온다
BDto dto=(BDto)request.getAttribute("Bto");
%>
	...
	<h3>MULTIBOARD - 글수정 </h3>
		<form action="<%=request.getContextPath()%>/edit.do?bno=${dto.bno}" method="post"  id="editForm" enctype="multipart/form-data" >
		   ...
		   <legend>	UPDATE</legend>
			...
			<div class="form-group">	
			<input type="text"  name="prev_img"   id="prev_img"  class="form-control" value="${dto.img}" readonly/>
            <label for="img">파일</label>
