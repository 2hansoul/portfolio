...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<%=request.getContextPath()%>/main/mainpage.jsp">main</a>
    </div>
   ...
   <%  
      ...
      <% }else{ %>
      <li><a href="<%=request.getContextPath() %>/list.do">board</a></li>
      <li><a href="<%=request.getContextPath()%>/main/api003_kakao-map.jsp" title="kakaomap">MAP</a></li>
